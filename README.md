...
- [ARCHITECTURE.md](./ARCHITECTURE.md) — архитектура системы, модули, сущности, паттерны, известные проблемы
- [API_DOCS.md](./API_DOCS.md) — полная документация REST API и WebSocket событий
