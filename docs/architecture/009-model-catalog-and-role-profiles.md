...
| Grok Build 0.1 | `x-ai/grok-build-0.1` | *(множитель не указан во входных данных — требует уточнения перед вводом в каталог)* |
...
- **Grok Build 0.1** — множитель не указан во входных данных; модель не включена ни в один профиль до уточнения множителя.
